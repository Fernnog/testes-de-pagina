...
export function setupGeradorEscala() {
    document.getElementById('formEscala').addEventListener('submit', (e) => {
        ...
        // =================== LÓGICA DE LIMPEZA CENTRALIZADA (CORREÇÃO) ===================
        ...
        const diagnosticContainer = document.getElementById('diagnosticReportContainer'); // Referência corrigida
        
        // 1. Limpa os resultados e relatórios anteriores
        ...
        // 2. Esconde e reseta o índice de equilíbrio
        if (balanceContainer) {
            balanceContainer.style.display = 'none';
            balanceContainer.onclick = null; // Limpa listener antigo para evitar múltiplos cliques
        }
        // =================================================================================
